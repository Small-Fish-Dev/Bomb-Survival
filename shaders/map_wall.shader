...
PS
{
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float3 l_20 = TexTriplanar_Normal( g_tNormal, g_sSampler0, l_3, i.vNormalOs );
		float3 l_21 = TransformNormal( i, Vec3OsToTs( l_20, i.vNormalOs.xyz, i.vTangentUOs_flTangentVSign.xyz, cross( i.vNormalOs.xyz, i.vTangentUOs_flTangentVSign.xyz ) * i.vTangentUOs_flTangentVSign.w ) );
		float4 l_22 = TexTriplanar_Color( g_tRough, g_sSampler0, l_3, i.vNormalOs );
		float4 l_23 = TexTriplanar_Color( g_tAO, g_sSampler0, l_3, i.vNormalOs );
